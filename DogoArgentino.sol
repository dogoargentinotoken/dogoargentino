/**
   4% fee divided into 2% burn & 2% fee auto add to the liquidity pool.
...
contract DogoArgentino is Context, IERC20, Ownable {
    ...
    string public constant name = "Dogo Argentino";
    string public constant symbol = "DARG";
    uint8 public constant decimals = 9;
    
    uint256 public _taxFee = 6; // REFLECTION RATE
    uint256 public _liquidityFee = 4; // BURN RATE
